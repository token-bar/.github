...
| **Multiple providers** | Cursor Personal & Team, OpenAI, Anthropic, and a custom HTTP proxy |
| **Usage forecasting** | Burn rate and exhaustion estimates from local history |
| **Native alerts** | macOS notifications at usage thresholds and forecasted exhaustion |
